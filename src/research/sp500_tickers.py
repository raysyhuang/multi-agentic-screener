"""Hardcoded S&P 500 ticker list (March 2026 snapshot).

Used as a fallback when the Wikipedia fetch in signal_backtest.py fails,
and as a deterministic source for reproducible backtests.

Tickers use Yahoo Finance format (BRK-B not BRK.B).
"""
